package org.ucimini.internetbrowserpro.adblock_minipro;
...
import org.ucimini.internetbrowserpro.utils.StringBuilderUtils;
import org.ucimini.internetbrowserpro.utils.Utils;

@Singleton
public class AdBlock_minipro {

    private static final String TAG = "AdBlock_minipro";
    ...
    @Inject
    AdBlock_minipro(@NonNull Application application, @NonNull PreferenceManager_mini PreferenceManager_mini) {
